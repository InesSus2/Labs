...
public class AhorcadoModel {
    ...
    */
    ...
    private void cargarImagenSegunEstiloYFallos() {
        if (estiloActual == 0) {
            return; // aún no hay estilo asignado
        }
        ...
        try {
            ...
            crearImagenDeRespaldo("Error imagen");
        }
    }
    /*
    private void cargarImagenSegunEstiloYFallos() {
