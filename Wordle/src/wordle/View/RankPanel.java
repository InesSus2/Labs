...
/**
 * Clase para RankPanel
 * 
 * @author Paulo Medeiros
 * @author Ines Jaso Pernod
 * 
 * @brief Esta clase se encarga de mostrar todos los jugadores en orden
 * de menos intentos a mas intentos y si han podido resolver la palabra.
 */
public class RankPanel extends JPanel {
    ...
    public RankPanel(Persona[] p_vec, int personas) {
        ...
        panelPersona.setLayout(new GridLayout(personas, 1, 1, 
                1));
        ...
        do {
            ...
            panelCentro[i].setLayout(new GridLayout(1, 3, 1, 
                    1));
